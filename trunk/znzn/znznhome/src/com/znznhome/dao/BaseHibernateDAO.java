...
public interface BaseHibernateDAO<E extends Serializable, PK extends Serializable> {
	/**
	 * 
	 ...
	 * @return 一行一列数据库
	 */
	Object getStackValue(DetachedCriteria criteria, String propertyName, String stackName);
	 ...
	 * @return 一个list集合
	 */
	List<E> findByNamedQueryAndNamedParam(String queryName, Map<String, Object> params);
	 ...
	 * @return 一个list集合
	 */
	List<E> findByCriteria(DetachedCriteria criteria, Integer firstResult, Integer maxResults);
