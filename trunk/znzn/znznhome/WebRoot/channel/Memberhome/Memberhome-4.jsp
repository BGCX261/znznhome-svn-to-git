...
<div class="grzx">
  <div class="leftcon">
    ...
    <div class="rightxx1">
	 <div class="zxtitle">
        <div class="leftdl"><span class="grzx4">将您需要的网址勾选即可,注意,您未定制的版块将不会出现在下面</span></div>
      </div>
      <div class="zxtitle">
        <div class="leftdl">新闻</div>
      </div>
      <div class="grxxcon">
...
<div class="smargin20"></div>
      <div class="zxtitle">
        <div class="leftdl">游戏<span class="glzt">(您勾选的版块将出现在首页)</span></div>
      </div>
      <div class="grxxcon">
        <table border="0" class="table table1" cellpadding="0" cellspacing="0" >
          <tr>
