...
<link rel="stylesheet" type="text/css" href="css/admin/table-list.css">
	<script type="text/javascript">
			...
			function znzn_index_refresh() {
				$.ajax({url:'create-index',type : 'POST', data:{indexBean:'url'}, success:function(data) {var obj_ = eval("(" + data + ")");alert(obj_.rstStr);}
								}); 
			}
	</script>
  ...
  <body>&nbsp; 
   ...
   <br/><div id="tableTitle" class="tableTitle">配置项列表 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="button" onclick="znzn_config_refresh();" value="刷新配置文件"/>  &nbsp; &nbsp;<input type="button" onclick="znzn_index_refresh();" value="更新索引"/></div> <hr><br/>
  <%
