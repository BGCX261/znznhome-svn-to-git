  ...
  <head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$("#idandname").formValidator({onShow:"请选择目录分类",onFocus:"目录必须选择",onCorrect:"输入正确"}).inputValidator({min:1,onError: "请选择目录分类，不能选根目录"});
...
%>
    ...
    <tr>
      <td>标签：</td>
      <td> <input name="tags" type="text" id="tags" size="25"> </td>
      <td  id="tagsTip" > </td>
      <td>来源：</td>
	...
	<tr>
      <td>简评：</td>
      <td colspan="2"> <textarea name="descr" id="descr" rows="4" cols="50"></textarea> </td>
      <td></td>
      <td></td>
	  <td></td>
    </tr>
