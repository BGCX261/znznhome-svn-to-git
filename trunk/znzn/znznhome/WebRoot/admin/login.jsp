...
<div class="content">
 ...
 <input type="hidden" name="loginFrom" value="admin"/>
 <table class="dltable" border="0" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>
    ...
    <td colspan="2"><input class="input1" id="password" name="password" type="password" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap"></td>
    <td width="107"><input class="input2" name="" type="checkbox" value="" />记住登录状态</td>
	<td width="67"><input onclick="JavaScript:document.uaform.submit();"  class="btn" id="btn1" name="btn1" type="button" /></td>
  </tr>
</table>
</form>
