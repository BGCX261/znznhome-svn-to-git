...
<ul class="daohang">
  ...
  <li class="bg2 ts2"><a href="hr_list.jsp" target="_self">人才招聘</a></li>
...
<div class="clearfloat"></div>
<div class="content">
  <div class="leftcon"><div style=" margin:0 auto; width:159px;"><img style="padding-top:16px;" src="images/con2_6.jpg"  width="159" height="44"/></div>
    <ul class="ldhbf">
      <li><a href="about.jsp" target="_self">企业简介 </a></li>
      <li><a class="fsxg" href="hr_list.jsp" target="_self">人才招聘</a></li>
      <li><a href="contact.jsp" target="_self">联系我们 </a></li>
    </ul>
  </div>
  <div class="rightcon"><div class="lxwbt2">人才招聘</div> <div class="rightcon1"> 
	
<%
  	ApplicationContext ctx = WebApplicationContextUtils.getWebApplicationContext(getServletContext());
  	NewsManager newsManager = (NewsManager)ctx.getBean("newsManager");
  	News news = newsManager.loadByCategoryEname("job");
	if (news != null){
