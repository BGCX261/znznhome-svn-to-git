...
<ul class="daohang">
  ...
  <li class="bg3 ts3"><a href="contact.jsp" target="_self">联系我们</a></li>
</ul>
<div class="jdt">
       <!-- 焦点图2 -->
      <div class="focus">
...
<div class="clearfloat"></div>
<div class="content">
  <div class="leftcon"><div style=" margin:0 auto; width:159px;"><img style="padding-top:16px;" src="images/con2_7.jpg"  width="159" height="44"/></div>
    <ul class="ldhbf">
      <li><a href="about.jsp" target="_self">企业简介 </a></li>
      <li><a href="hr_list.jsp" target="_self">人才招聘</a></li>
      <li><a class="fsxg" href="contact.jsp" target="_self">联系我们 </a></li>
    </ul>
  </div>
  <div class="rightcon"><div class="lxwbt2">联系我们</div> <div class="rightcon1"> 
	
<%
  	ApplicationContext ctx = WebApplicationContextUtils.getWebApplicationContext(getServletContext());
  	NewsManager newsManager = (NewsManager)ctx.getBean("newsManager");
  	News news = newsManager.loadByCategoryEname("contact");
	if (news != null){
