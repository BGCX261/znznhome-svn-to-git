...
<ul class="daohang">
  ...
  <li class="bg3"><a href="news-list?ename=news01" target="_self">新闻中心</a></li>
  <li class="bg3"><a href="cases-list?ename=cases01" target="_self">工程案例</a></li>
  <li class="bg3"><a href="product-list?ename=product01" target="_self">产品中心</a></li>
  <li class="bg3"><a href="feedBack-list" target="_self">在线咨询</a></li>
  <li class="bg3"><a href="hr_list.jsp" target="_self">人才招聘</a></li>
  <li class="bg2"><a href="contact.jsp" target="_self">联系我们</a></li>
</ul>
<div class="jdt">
       <!-- 焦点图2 -->
      <div class="focus">
...
<div class="content">
  <div class="leftcon"><div style=" margin:0 auto; width:159px;"><img style="padding-top:16px;" src="images/con2_1.jpg"  width="159" height="44"/></div>
    <ul class="ldhbf">
      ...
      <li><a class="fsxg" href="#" target="_blank">社会责任</a></li>
    </ul>
  </div>
  <div class="rightcon"><img style="padding-left:22px;" src="images/con1_1.jpg" />  <div class="rightcon1"> 
   <p>大江网讯记者秦海峰报道：4月18日，大江网记者获悉，上饶市质监局纪检调查组已对“龟峰明胶有限公司长期销售工业明胶”监管不力的问题进行了调查，初步认定弋阳县质监局南岩分局局长胡某某存在监管不力等问题，目前已被停止职务，接受调查。</p>
<p>
4月15日，央视曝光江西弋阳县龟峰明胶有限公司用皮革加工工业明胶，出售后用来加工药用胶囊。随后，弋阳县有关部门立即对该厂作出停厂整顿，原材料和产品被查封，董事长被公安机关依法控制，并进行相关调查。
</p><p>
4月17日，弋阳龟峰明胶有限公司董事长李明元已被刑拘，分管生产的负责人取保候审，另有5名相关人员被公安机关严密控制。</p>
<p>目前，弋阳县质监、公安部门正对该公司生产的工业明胶数量和销售去向情况进行详细调查核实，核实结果将在第一时间依规向有关方面通报。</p>
<p>
4月17日，弋阳龟峰明胶有限公司董事长李明元已被刑拘，分管生产的负责人取保候审，另有5名相关人员被公安机关严密控制。</p>
<p>目前，弋阳县质监、公安部门正对该公司生产的工业明胶数量和销售去向情况进行详细调查核实，核实结果将在第一时间依规向有关方面通报。</p>
</div>
