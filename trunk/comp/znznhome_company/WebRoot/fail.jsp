...
<%@ page import="java.sql.Timestamp,com.znznhome.util.*,com.znznhome.model.*,com.znznhome.service.*,  java.text.SimpleDateFormat" %>
...
<center><br/><br/><br/><br/><img src="images/tjcc.gif"/><br/><br/><div class="tjwz"> <span>很遗憾！</span>您的信息未提交成功，稍后请重试！ </div></center>
