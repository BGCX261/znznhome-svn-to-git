...
String sql_news_01 = "select * from znzn_news where recflag=1 and categoryid=4 order by createtime desc limit 0, 5;";
String sql_news_02 = "select * from znzn_news where recflag=1 and categoryid=5 order by createtime desc limit 0, 5;";
String sql_product = "select * from znzn_product where recflag=1 order by createtime desc limit 0, 10;";
String sql_cases = "select * from znzn_cases where recflag=1 order by createtime desc limit 0, 5;";
  ...
  <div class="con1">
    ...
    <div class="rightcon r">
      ...
      <ul>
        ...
        <li><a href="product-list?categoryid=20&countNumber=20" target="_self">新型环保材料</a></li>
      </ul>
...
<div class="con2">
  <div class="leftcon l">
    <div class="title"><span><a href="about.jsp" target="_self">关于宅男宅女</a></span></div>
    <div class="midcon">
      <div class="tp l"><a href="about.jsp" target="_self"><img src="images/tp.gif" width="115" height="74" /></a></div>
      <div class="txt l">北京宅男宅女商贸有限公司成立于2008年8月29日，主要从事建筑装饰装修材料的生产、销售与研发。 公司下设企业管理部、市场营销部、工程技术研发部、财务部、客户服务部等部门.. <a href="about.jsp" target="_self">查看详细 ></a></div>
    </div>
  </div>
  <div class="leftcon r">
    <div class="title"><span><a href="product-list?categoryid=17&countNumber=20" target="_self">产品展示</a></span><a class="ra" href="product-list?categoryid=17&countNumber=20" target="_self"></a></div>
    <div class="midcon">
      <div class="hlhb_con">
        <!-- 滚动图片 beigin -->
        <script language="javascript"> 
...
<div class="con3">
  <div class="leftcon l margr10">
    <div class="title"><span><a href="news-list?categoryid=4&countNumber=7" target="_self">企业新闻</a></span><a class="ra" href="news-list?categoryid=4&countNumber=7" target="_self"></a></div>
    <div class="midbf">
      <ul>
...
%>
  ...
  <div class="leftcon l margr10 wd234">
    <div class="title wd234"><span><a href="news-list?categoryid=5&countNumber=7" target="_self">行业新闻</a></span><a class="ra" href="news-list?categoryid=5&countNumber=7" target="_self"></a></div>
    <div class="midbf">
      <ul>
<%
...
%>
  ...
  <div class="leftcon leftcon wd447 l">
    <div class="title wd447"><span><a href="cases-list?categoryid=10&countNumber=5" target="_self">成功案例</a></span><a class="ra" href="cases-list?categoryid=10&countNumber=5" target="_self"></a></div>
