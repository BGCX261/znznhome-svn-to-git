...
<div class="con2">
<div class="leftcon l">
 <div class="title">您当前的位置：<a href="index.jsp" target="_self">首页</a> > <a class="ra" href="product-list?categoryid=17&countNumber=20" target="_self">产品展示</a> > <a href="product-list?categoryid=<%=categoryid %>&countNumber=20" target="_self"><%=categoryname %></a> </div>
...
<%=content %>
 ...
 <%
 String sql = "select * from znzn_product where recflag=1 and categoryid=" + categoryid + " order by createtime desc limit 0, 10;";
