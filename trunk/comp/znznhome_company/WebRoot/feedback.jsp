...
<form action="Feedback-add" method="post" id="feedbackform" name="feedbackform" onsubmit="return validate(); ">
  <div class="leftcon l">
    <div class="title">您当前的位置：<a href="index.jsp" target="_self">首页</a> > <a class="ra" href="product-list?categoryid=17&countNumber=20" target="_self">产品展示</a> > <a class="ra" href="feedback.jsp" target="_self">订购反馈</a> > </div>
    
    <div class="midcon1">
<div class="clearfloat"></div>
<div class="height15"></div>

<table class="cpddbg" border="0" cellpadding="0" cellspacing="0">
 <tr>
    <td width="125" align="right">反馈主题：</td>
    <td width="395" colspan="2">
    <select class="input" name="subject">
    <option value="产品购买">产品购买</option>
    <option value="索取资料">索取资料</option>
    <option value="商务合作">商务合作</option>
    <option value="其它反馈">其它反馈</option>
    </select></td>
    
  </tr>

    <tr>
    <td  align="right"><img src="images/xxx.gif" />姓名：</td>
    <td><input class="input1" id="contactperson" name="contactperson" type="text" /></td>
    <td id="contactpersonTip"></td>
  </tr>
  ...
  <tr>
    <td  align="right"><img src="images/xxx.gif" />Email：</td>
    <td><input class="input1" id="email" name="email" type="text" /></td>
    <td id="emailTip"></td>
  </tr>
  <tr>
    <td  align="right">电话：</td>
    <td><input class="input1" name="tel" type="text" /></td>
    <td></td>
  </tr>
   <tr>
    <td  align="right"><img src="images/xxx.gif" />手机：</td>
    <td><input class="input1" id="mobile" name="mobile" type="text" /></td>
    <td id="mobileTip"></td>
  </tr>
   <tr>
    <td  align="right">传真：</td>
    <td><input class="input1" name="fax" type="text" /></td>
    <td></td>
  </tr>
   <tr>
    <td  align="right">单位名称：</td>
    <td><input class="input1" name="company" type="text" /></td>
    <td></td>
  </tr>
  <tr>
    <td  align="right">省/市：</td>
    <td><input class="input1" name="province" type="text" /></td>
    <td></td>
  </tr>
  <tr>
    <td  align="right">详细地址：</td>
    <td><input class="input1" name="address" type="text" /></td>
    <td></td>
  </tr>
  <tr>
    <td  align="right">邮政编码：</td>
    <td><input class="input1" name="postcode" type="text" /></td>
    <td></td>
  </tr>
  <tr>
    <td  align="right">信息描述：</td>
    <td colspan="2"><textarea class="input3" name="detail" cols="" rows=""></textarea></td>
  </tr>

  </table>
<div style=" border-bottom:1px dashed #c2c0c7; margin:25px auto; width:694px; "/></div>
<table class="cpddbg" border="0" cellpadding="0" cellspacing="0">
 <tr>
    <td width="125" align="right"></td>
    <td width="395" colspan="2"><input class="btn" name="" type="submit" value="提交信息" />&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn"  name="" type="reset"   value="重新填写" /></td>
  </tr>
</table>
