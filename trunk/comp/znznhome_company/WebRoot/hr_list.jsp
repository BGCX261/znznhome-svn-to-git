...
<div class="con2">
<div class="leftcon l">
 <div class="title">您当前的位置：<a href="index.jsp" target="_self">首页</a> > <a class="ra" href="job-list?countNumber=9" target="_self"> 招聘中心</a></div>
...
%>     	
	  		...
	  		<!-- ------------以下HTML分页区------------ -->
	  	<form name="form1"  action="job-list">	
	  ...
	  <a class="btn1" href="job-list?countNumber=7&pageNo=<%=pageNo-1%>" >上一页</a>
	  <a class="btn1 btn2" href="job-list?countNumber=7&pageNo=<%=pageNo+1%>" target="_blank">下一页</a>
