...
<div class="con2">
<div class="leftcon l">
 <div class="title">您当前的位置：<a href="index.jsp" target="_self">首页</a> > <a class="ra" href="news-list?categoryid=4&countNumber=7" target="_self">公司动态</a>  > <a href="news-list?categoryid=<%=ctgid %>&countNumber=7" target="_self"><%=ctgname %></a>  </div>
...
%>    
	  		...
	  		<!-- ------------以下HTML分页区------------ -->
	  	<form name="form1"  action="news-list">	
	  ...
	  <a class="btn1" href="news-list?categoryid=<%=ctgid %>&countNumber=7&pageNo=<%=pageNo-1%>" >上一页</a>
	  <a class="btn1 btn2" href="news-list?categoryid=<%=ctgid %>&countNumber=7&pageNo=<%=pageNo+1%>" target="_blank">下一页</a>
