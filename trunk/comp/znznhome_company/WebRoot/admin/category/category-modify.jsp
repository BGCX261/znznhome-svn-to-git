...
<link rel="stylesheet" type="text/css" href="css/admin/table-add.css">
 ...
 %>
      ...
      <!-- ----------表单开始-----------   -->
  <form action="admin/category-modify" method="post" id="hshcategoryadd" name="hshcategoryadd">
...
%>
   ...
   <tr>
      <td>目录英文名：</td>
      <td>
      <input name="ename" type="text" id="ename" size="30" value="<%=ename %>">
      </td>
      <td  id="pnameTip" > </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>目录编码：</td>
      <td>
      <input name="categorycoding" type="text" id="categorycoding" size="30" value="<%=categorycoding %>">
      </td>
    ...
    <tr>
      <td>目录描述：</td>
      <td> <input name="descr" type="text" id="descr" size="30" value="<%=descr %>"> </td>
