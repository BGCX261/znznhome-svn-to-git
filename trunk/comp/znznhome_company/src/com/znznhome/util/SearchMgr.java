...
public class SearchMgr {
	...
	public Page search(String sql_count, String sql, String search_content, String search_condition, Class c) {
	...
	public Page search(String pageNo, Class c) {
	...
	public Page search(String sql_count, String sql,  Class c) {
	...
	public Page search(String sql_count, String sql,  Class c, int pageSize) {
