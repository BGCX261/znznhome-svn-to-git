...
<div class="con2">
<div class="leftcon l">
 <div class="title">您当前的位置：<a href="index.jsp" target="_self">首页</a> > <a class="ra" href="Cases-list.action?categoryid=10&countNumber=5" target="_self">案例分享</a>  > <a href="Cases-list.action?categoryid=<%=categoryid %>&countNumber=7" target="_self"><%=categoryname %></a></div>
   <div class="midcon1">
