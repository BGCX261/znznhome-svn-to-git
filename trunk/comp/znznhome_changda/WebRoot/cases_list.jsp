...
<div class="con2">
<div class="leftcon l">
 <div class="title">您当前的位置：您当前的位置：<a href="index.jsp" target="_self">首页</a> > <a class="ra" href="Cases-list.action?categoryid=10&countNumber=5" target="_self">案例分享</a>  > <a href="Cases-list.action?categoryid=<%=ctgid %>&countNumber=7" target="_self"><%=ctgname %></a></div>
   <div class="midcon">
...
%>    
	  		...
	  		<!-- ------------以下HTML分页区------------ -->
	  	<form name="form1"  action="Cases-list.action">	
	  ...
	  <a class="btn1" href="Cases-list.action?categoryid=<%=ctgid %>&countNumber=7&pageNo=<%=pageNo-1%>" >上一页</a>
	  <a class="btn1 btn2" href="Cases-list.action?categoryid=<%=ctgid %>&countNumber=7&pageNo=<%=pageNo+1%>" target="_blank">下一页</a>
...
<div class="rightcon r">
 <div class="title"><a href="Cases-list.action?categoryid=10&countNumber=5" target="_self">案例分享</a></div>
      <ul class="ul1">
        <li><a href="Cases-list.action?categoryid=10&countNumber=5" target="_self">办公空间</a></li>
        <li><a href="Cases-list.action?categoryid=11&countNumber=5" target="_self">餐饮空间</a></li>
        <li><a href="Cases-list.action?categoryid=12&countNumber=5" target="_self">医疗空间</a></li>
        <li><a href="Cases-list.action?categoryid=13&countNumber=5" target="_self">休闲娱乐空间</a></li>
        <li><a href="Cases-list.action?categoryid=14&countNumber=5" target="_self">酒店会所空间</a></li>
		<li><a href="Cases-list.action?categoryid=15&countNumber=5" target="_self">商业展示空间</a></li>
        <li><a href="Cases-list.action?categoryid=16&countNumber=5" target="_self">2010十佳方案</a></li>
      </ul>
