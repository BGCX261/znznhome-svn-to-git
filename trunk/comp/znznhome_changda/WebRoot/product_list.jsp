...
<div class="con2">
  <div class="leftcon l">
    <div class="title">您当前的位置：<a href="index.jsp" target="_self">首页</a> > <a class="ra" href="Product-list.action?categoryid=17&countNumber=20" target="_self">产品展示</a> > <a href="Product-list.action?categoryid=<%=ctgid %>&countNumber=20" target="_self"><%=ctgname %></a></div>
...
<div class="clearfloat"></div>
	  		...
	  		<!-- ------------以下HTML分页区------------ -->
	  	<form name="form1"  action="Product-list.action">	
	  ...
	  <a class="btn1" href="Product-list.action?categoryid=<%=ctgid %>&countNumber=7&pageNo=<%=pageNo-1%>" >上一页</a>
	  <a class="btn1 btn2" href="Product-list.action?categoryid=<%=ctgid %>&countNumber=7&pageNo=<%=pageNo+1%>" target="_blank">下一页</a>
