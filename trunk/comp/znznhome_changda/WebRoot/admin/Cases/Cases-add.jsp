...
<link rel="stylesheet" type="text/css" href="css/admin/table-add.css">
  ...
  <body>
      ...
      <br>
      	<center><h5>案例添加</h5></center><hr>
    
      <!-- ----------表单开始-----------   -->
  <form action="admin/Cases-add.action" method="post" id="casesaddform" name="casesaddform">
...
%>
    ...
    <tr>
      <td>项目名称：</td>
      <td colspan="2"> <input type="text" name="casename"  size="40"> </td>
	  <td>SEO标题</td>
      <td>
    ...
    <tr>
      <td>规模：</td>
      <td> <input name="origin" type="text" id="scale" size="40"> </td>
    ...
    <tr>
      <td>设计时间：</td>
      <td> <input name="casetime" type="text" id="casetime" size="40">
