<%@ page language="java" import="java.util.*, net.fckeditor.*" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" %>
<%@ page import="java.sql.Timestamp,com.changda.util.*,com.changda.model.*,com.changda.service.*,com.opensymphony.xwork2.ActionContext" %>
...
<link rel="stylesheet" type="text/css" href="css/admin/table-add.css">
  ...
  <body>
    ...
    <%
    	...
    	ProductManager nm = ProductManager.getInstance();
    ...
    %>
      ...
      <!-- ----------表单开始-----------   -->
  <form action="admin/Product-modify.action" method="post" id="productaddform" name="productaddform">
