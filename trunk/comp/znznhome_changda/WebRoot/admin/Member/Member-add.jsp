...
<html>
  ...
  <body>
             <br>
      	<center><h5>添加会员</h5></center><hr>

      <!-- ----------表单开始-----------   -->
  <form action="admin/Member-add.action" method="post" id="yysnewsaddform" name="yysnewsaddform">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="8%">会员名：</td>
      <td width="24%"><input id="name" name="name" type="text" id="name" size="30">  </td>
    ...
    <tr>
      <td>会员密码：</td>
      <td> <input name="password" type="password" id="Memberaddress" size="30"> </td>
      <td  id="MemberTip" > </td>
      <td>审核:</td>
      <td>
    ...
    <tr>
      <td>email：</td>
      <td> <input name="email" type="input" id="email" size="30"> </td>
      <td  id="MemberTip" > </td>
      <td>&nbsp;</td>
      <td>
		&nbsp;
