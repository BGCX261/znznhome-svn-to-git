...
新闻列表：<br>
  ...
  %>
  <form action="admin/News-manager.action" method="post" name="hshproductmgsearch">
...
<form action="admin/News-updateMultipleNews.action" method="post" name="mainform">
...
%>
  ...
  <tr class="tr2">
	    ...
	    <td><a href="admin/News-delete.action?newsID=<%=id %>"><img style="border-width: 0px; " src="<%=basePath %>/images/admin/del.gif"/></a></td>
	  </tr>
	  	<%} //-- for循环 --
		...
		<!-- ------------以下HTML分页区------------ -->
			<form name="form1"  action="admin/News-manager.action">			
			&nbsp;&nbsp;&nbsp;&nbsp; <a href="admin/News-manager.action?pageNo=1">首页</a> 
			<a href="admin/News-manager.action?pageNo=<%=pageNo-1%>">上一页</a> 
			<a href="admin/News-manager.action?pageNo=<%=pageNo+1%>">下一页</a>   
			<a href="admin/News-manager.action?pageNo=<%=totalPages%>">尾页</a> 
