...
<link rel="stylesheet" type="text/css" href="css/admin/table-add.css">
  ...
  <body>
      ...
      <br>
      	<center><h5>新闻添加</h5></center><hr>
    
      <!-- ----------表单开始-----------   -->
  <form action="admin/News-add.action" method="post" id="newsaddform" name="newsaddform">
...
%>
    ...
    <tr>
      <td>作者：</td>
      <td colspan="2"> <input type="text" name="author"  size="40"> </td>
	  <td>SEO标题</td>
      <td>
    ...
    <tr>
      <td>来源：</td>
      <td> <input name="origin" type="text" id="origin" size="40"> </td>
