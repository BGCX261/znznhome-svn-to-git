...
<link rel="stylesheet" type="text/css" href="css/admin/table-add.css">
  ...
  <%
	...
	c = cm.loadByID(Integer.parseInt(id));	
	String name = c.getName();
	String templatefilename = c.getTemplatefilename();
	int pid = c.getPid();
 ...
 %>
      ...
      <!-- ----------表单开始-----------   -->
  <form action="admin/Category-modify.action" method="post" id="hshcategoryadd" name="hshcategoryadd">
