...
招聘职位列表：<br>
  ...
  %>
  <form action="admin/Job-manager.action" method="post" name="hshproductmgsearch">
...
%>
  ...
  <tr class="tr2">
	    ...
	    <td><a href="admin/Job-delete.action?jobID=<%=id %>"><img style="border-width: 0px; " src="<%=basePath %>/images/admin/del.gif"/></a></td>
	  </tr>
	  	<%} //-- for循环 --
		...
		<!-- ------------以下HTML分页区------------ -->
			<form name="form1"  action="admin/Job-manager.action">			
			&nbsp;&nbsp;&nbsp;&nbsp; <a href="admin/Job-manager.action?pageNo=1">首页</a> 
			<a href="admin/Job-manager.action?pageNo=<%=pageNo-1%>">上一页</a> 
			<a href="admin/Job-manager.action?pageNo=<%=pageNo+1%>">下一页</a>   
			<a href="admin/Job-manager.action?pageNo=<%=totalPages%>">尾页</a> 
