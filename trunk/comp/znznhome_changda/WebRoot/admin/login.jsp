...
<div class="content">
 ...
 <form method="post" action="admin/User-login.action" name="uaform">
 ...
 <table class="dltable" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td nowrap="nowrap"></td>
    <td width="107">&nbsp;</td>
	<td width="67"><input onclick="JavaScript:document.uaform.submit();"  class="btn" name="" type="button" /></td>
  </tr>
</table>
</form>


<div class="bqsm">&nbsp; <span>&nbsp; </span>&nbsp; &nbsp; 
</div>
